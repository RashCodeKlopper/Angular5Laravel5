...
var AppComponent = /** @class */ (function () {
    function AppComponent(_http) {
        this._http = _http;
        this.title = 'Laravel 5 Angular 5 App!';
        this.apiUrl = 'http://angular-laravel:8000';
    ...
    AppComponent.prototype.onSubmit = function (form) {
        return this._http.post(this.apiUrl + '/api/items', JSON.stringify(form.value), { headers: this.headers })
            .toPromise()
